...
class Car {
  ...
  drive(distance) {
    ...
    // if the gallons used is greater than what the tank can drive, then we increase odometer to the amount we can drive, tank * milesPerGallon
...
class Instructor extends Lambdasian {
  constructor({specialty, favLanguage, catchPhrase, ...lamdasianProps}) {
    super(lamdasianProps)
...
class Student extends Lambdasian{
  constructor({previousBackground, className, favSubjects, ...lamdasianProps}) {
    super(lamdasianProps)
  ...
  listSubjects() {
    return this.favSubjects.reduce((prev, next) => prev += `${next}, `, 'Loving ').slice(0, -2) + '!'
  }
...
class ProjectManager extends Instructor {
  constructor({gradClassName, favInstructor, ...instructorArgs}) {
